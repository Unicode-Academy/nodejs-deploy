...
import { APP_PORT, VIEWS, options, cookie } from "./src/config/app-config.js";
...
//   "/styles/css",
//   express.static(
//     path.resolve(process.cwd(), "node_modules/bootstrap/dist/css"),
//   ),
// );
// app.use(
//   "/js",
//   express.static(path.resolve(process.cwd(), "node_modules/bootstrap/dist/js")),
// );
// // Allow jQuery
// app.use(
//   "/js",
//   express.static(path.resolve(process.cwd(), "node_modules/jquery/dist")),
// );
